      ...
      <div className="relative z-10">
        <header className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
          <div className="flex items-center gap-3">
            <div className="rounded-2xl bg-white/80 p-2 backdrop-blur">
              <Sparkles className="h-5 w-5 text-pink-500" />
            </div>
            <span className="text-lg font-semibold tracking-tight text-black">FluxScale Performance</span>
          </div>
          <a href="#cta" className="group inline-flex items-center gap-2 rounded-full border border-black/10 bg-white/80 px-4 py-2 text-sm font-medium text-black backdrop-blur transition hover:bg-white">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pt-16 lg:pt-24">
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white/80 px-3 py-1 text-xs text-black/80 backdrop-blur">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <a href="#cta" className="inline-flex items-center justify-center gap-2 rounded-xl border border-black/10 bg-white/80 px-5 py-3 font-medium text-black shadow-[0_8px_40px_-8px_rgba(168,85,247,0.25)] backdrop-blur transition hover:bg-white">
                <Rocket className="h-5 w-5 text-purple-700" />
                Get a Free Audit
              </a>
              <a href="#case-studies" className="inline-flex items-center justify-center rounded-xl border border-black/10 bg-black/10 px-5 py-3 font-medium text-black/90 backdrop-blur transition hover:bg-black/20">
                View Case Studies
              </a>
            </div>
